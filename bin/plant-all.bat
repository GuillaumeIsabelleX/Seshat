...
call java -jar h:\Dropbox\seshat\lib\plantuml.jar  -tscxml "%~1" -failfast2 -quiet -duration
call java -jar h:\Dropbox\seshat\lib\plantuml.jar  -thtml "%~1" -failfast2 -quiet -duration
