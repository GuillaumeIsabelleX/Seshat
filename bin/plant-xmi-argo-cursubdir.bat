@echo off
Echo PUML Generator - Create XMI
...
rem call java -jar h:\Dropbox\seshat\lib\plantuml.jar  "%~1" %ext_puml%


mkdir -p "%~2"

call java -jar h:\Dropbox\seshat\lib\plantuml.jar -o "%~2" -failfast2 -quiet -duration "%~1" 
call java -jar h:\Dropbox\seshat\lib\plantuml.jar -o "%~2" -txmi:argo -failfast2 -quiet -duration "%~1" 

rem call java -jar h:\Dropbox\seshat\lib\plantuml.jar  -thtml "%~1" -failfast2 -quiet -duration
rem call java -jar h:\Dropbox\seshat\lib\plantuml.jar  -teps "%~1" -failfast2 -quiet -duration
echo done.
