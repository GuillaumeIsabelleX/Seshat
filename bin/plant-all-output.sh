...
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -tpng -failfast2 -quiet -duration "$1" 
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -tscxml -failfast2 -quiet -duration "$1"
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -txmi -failfast2 -quiet -duration "$1"
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -thtml -failfast2 -quiet -duration "$1"
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -teps -failfast2 -quiet -duration "$1"
java -jar ~/Dropbox/Seshat/lib/creaplant.jar -o "$2"  -tsvg -failfast2 -quiet -duration "$1"
