...
call java -jar h:\Dropbox\seshat\lib\plantuml.jar  "%~1" -failfast2 -quiet -duration
call java -jar h:\Dropbox\seshat\lib\plantuml.jar  -txmi "%~1" -failfast2 -quiet -duration
